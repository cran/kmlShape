...
const int diagonale=0,gauche=1,haut=2, directionStart=3 ; //ces valeurs sont fixées pour tout le programme
...
// fonction renvoyant "l'emplacement" du nombre minimum dans le cas triangulaire supérieur droit
